...
public class DBUtilities {
	...
	public void showSQLException(SQLException e) {
		AlertsUtilities.showWarningDialog("Upozorenje", "Nepravilan rad sa bazom podataka!",
				"Kod greške: " + e.getErrorCode() + "\nPoruka: " + e.getMessage());
	}

	public void showErrorMessage(String poruka) {
		AlertsUtilities.showWarningDialog("Upozorenje", "Nepravilan rad sa bazom podataka!", poruka);
	}
